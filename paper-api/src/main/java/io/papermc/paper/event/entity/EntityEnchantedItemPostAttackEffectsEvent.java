...
@NullMarked
public class EntityEnchantedItemPostAttackEffectsEvent extends EntityEnchantedItemInUseEvent implements Cancellable {
    ...
    @ApiStatus.Internal
    public EntityEnchantedItemPostAttackEffectsEvent(
        final Entity entity,
